...
public interface AccountsService {
    ...
    Result<Application> creatApplication(String domain, String userName, Application application);

    Result<Application> creatNewKey(String domain, String userName, String applicationId);
